...
const UpdateTasksGiven = () => {
  ...
  const { singleTasksGiven, isTasksGiveneUpdated, TasksGivenList } = tasks;
  ...
  // if (taskGivenUser?._id && taskAssignedUser?._id) {
  //   const demotrue = taskGivenUser?._id === taskAssignedUser?._id;
  //   console.log(demotrue, "demoturn");
  //   if (isTasksGiveneUpdated || taskGivenUser?._id === taskAssignedUser?._id)
  ...
  const findTheTasksGivenTrue = filteredTasksGivenList?.find(
    (each) => each?._id === id
  );
  console.log(findTheTasksGivenTrue, "findTheTasksGivenTrue");

  console.log(filteredTasksGivenList, "findTheTasksGivenTrue list");

  if (filteredTasksGivenList) {
    if (isTasksGiveneUpdated || !findTheTasksGivenTrue) {
