...
const OrgExitDetails = () => {
  ...
  const filteredExitDetailsList = exitDetailsList?.filter((eachid) => {
                  ...
                  <tbody>
                    {exitDetailsList?.map((exitDetailsEach) => (
                      <tr key={exitDetailsEach?.id}>
                        ...
                        <td>
                          {dateOnlyFormate(exitDetailsEach?.separationDate)}
                        </td>
                        ...
                        <td>{dateTimeFormate(exitDetailsEach?.createdAt)}</td>
                        <td>
                        ...
                        <td>{dateTimeFormate(exitDetailsEach?.updatedAt)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div className="cs_asset_bg_div">
              ...
              <div className="cs_asset_table">
                ...
                <table>
                  ...
                  <tbody>
                    {filteredExitDetailsList?.map((exitDetailsEach) => (
                      <tr key={exitDetailsEach?.id}>
                        {" "}
                        <td>
                          <Link
