...
const OrgProjectTeam = () => {
  ...
  const { TeamList } = team;
  console.log(
    "🚀 ~ file: OrgProjectTeam.js:16 ~ OrgProjectTeam ~ TeamList:",
    TeamList
  );
          ...
          {normalAdminAccessGivenFun(getAccessData?.Access) && (
            <div className="cs_asset_bg_div">
              ...
              <div className="cs_aaset_add_div">
                <h1 className="cs_asset_head_main">Team</h1>
              ...
              <div className="cs_asset_table">
                ...
                <table>
                  ...
                  <tbody>
                    {TeamList?.map((TeamEach) => (
                      <tr key={TeamEach?.id}>
                        <td>
                          <Link
                            className="cs_div_edit_icons_all"
                            to={`/organization/team/update/${TeamEach?.id}`}
                          >
                            <svg
                        ...
                        <td>
                          <Link
                            className="cs_div_edit_icons_all"
                            to={`/organization/team/delete/${TeamEach?.id}`}
                          >
                            <svg
                              className="cs_all_edit_icons_project"
                              xmlns="http://www.w3.org/2000/svg"
                        ...
                        <td>
                          <Link
                            className="cs_div_edit_icons_all"
                            to={`/organization/team/view/${TeamEach?.id}`}
                          >
                            <svg
                              className="cs_all_edit_icons_project"
                              xmlns="http://www.w3.org/2000/svg"
                        ...
                        <td>{TeamEach?.TeamName}</td>
                        <td>
                          {`${TeamEach?.addedBy?.basicInformation?.firstName} ${TeamEach?.addedBy?.basicInformation?.lastName} ${TeamEach?.addedBy?.basicInformation?.employerId}`}
                        </td>
                        <td>{dateTimeFormate(TeamEach?.createdAt)}</td>
                        <td>
                          {`${TeamEach?.ModifiedBy?.basicInformation?.firstName} ${TeamEach?.ModifiedBy?.basicInformation?.lastName} ${TeamEach?.ModifiedBy?.basicInformation?.employerId}`}
                        </td>
                        <td>{dateTimeFormate(TeamEach?.updatedAt)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
